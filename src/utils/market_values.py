class MarketValues:
    def __init__(self, name: str, time: float, sell_offer: int, buy_offer: int, month_sell_offer: int, month_buy_offer: int, sold: int, bought: int, highest_sell: int, lowest_buy: int, approx_offers: int, id: int):
    ...
    def from_string(string: str):
        ...
        return MarketValues(name, -1, float(sell_offer), float(buy_offer), float(month_sell_offer), float(month_buy_offer), float(sold), float(bought), -1, -1, float(active_traders), -1)
    ...
    def from_history_string(string: str):
        ...
        return MarketValues(None, float(time), float(sell_offer), float(buy_offer), -1, -1, float(sold), float(bought), -1, -1, float(active_traders), -1)
